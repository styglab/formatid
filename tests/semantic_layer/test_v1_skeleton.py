...
from services.semantic_layer.lib.planner import build_not_found_plan, validate_plan
...
class SemanticLayerSkeletonTests(unittest.TestCase):
    def test_runtime_context_identifies_semantic_layer(self) -> None:
        context = build_runtime_context()

        self.assertEqual(context["service"], "semantic_layer")
    ...
    def test_seed_semantic_registry_prepares_core_types(self) -> None:
        ...
        self.assertGreaterEqual(result["semantic_type_count"], 3)
