    ...
    *,
    ...
    return {
        ...
        "instructions": [
            ...
            "Also propose canonical entity and canonical attribute names for semantic-model authoring.",
        ],
        "registry_snapshot": {
            "semantic_types": [
                {
            ...
            "suggestions": [
                {
                    ...
                    "proposed_canonical_entity_name": "string",
                    "proposed_canonical_attribute_name": "string",
                    "confidence": "float",
                    "rationale": "string",
        ...
        normalized.append(
            {
                ...
                "proposed_canonical_entity_name": str(item.get("proposed_canonical_entity_name") or ""),
                "proposed_canonical_attribute_name": str(item.get("proposed_canonical_attribute_name") or ""),
