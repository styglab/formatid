...
export function OperationsTable({ items, selectedId, onSelect, fieldCounts }: OperationsTableProps) {
  return (
          ...
          {items.map((operation) => {
            ...
            return (
              ...
              >
                ...
                <td className="px-4 py-3 text-muted-foreground">{operation.http_method || operation.access_type || "-"}</td>
