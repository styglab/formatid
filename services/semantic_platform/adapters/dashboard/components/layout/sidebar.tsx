...
const items: Array<{
  ...
  },
  {
    id: "mappings",
    label: "Mappings",
    note: "raw fields to canonical meaning",
    icon: Blocks,
    enabled: true
  },
  {
  ...
  },
  {
    id: "operations",
    label: "Operations",
    note: "execution registry and variants",
    icon: GitBranch,
    enabled: true
  },
  {
    id: "governance",
    label: "Governance",
    note: "reviews, approvals, and audit",
    icon: FileCheck2,
    enabled: true
  },
  {
  ...
  return (
    ...
    >
      <div className={`mb-6 flex px-2 ${collapsed ? "justify-center" : "items-center justify-between"}`}>
        {!collapsed ? <div className="text-sm font-semibold">Semantic Platform</div> : null}
        <button
          type="button"
          onClick={onToggle}
