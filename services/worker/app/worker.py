...
from services.worker.app.executor import execute_task
from services.worker.app.logger import configure_logging, get_logger, log_event
from services.worker.app.queue import RedisTaskQueue, TaskQueue
from services.worker.app.task_loader import load_task_modules
...
def is_retryable_error(exc: Exception) -> bool:
    return not isinstance(
        exc,
        (InvalidTaskRouteError, UnknownTaskRoutingError, UnknownTaskError, WorkerTaskNotAllowedError),
    )
