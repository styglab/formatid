...
from apps.g2b.pipeline_scheduler.app.support.collection_window import build_bid_list_payload
...
async def enqueue_bid_list_if_due(
    *,
    ...
    task_definition = get_task_definition(INGEST_API_TASK)
    ...
    payload = await build_bid_list_payload(
        service_name="g2b_ingest_bid_list_collect",
        queue_name=task_definition.queue_name,
