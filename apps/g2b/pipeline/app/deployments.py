...
from apps.g2b.pipeline.app.flows.bid_realtime_ingest import g2b_bid_realtime_ingest
from apps.g2b.pipeline.app.flows.success_bid_initial_ingest import g2b_success_bid_initial_ingest
from apps.g2b.pipeline.app.flows.success_bid_realtime_ingest import g2b_success_bid_realtime_ingest
...
def deploy_g2b_success_bid_realtime_ingest() -> None:
    interval_minutes = int(os.getenv("G2B_SUCCESS_BID_REALTIME_INTERVAL_MINUTES", "5"))
    deployment = g2b_success_bid_realtime_ingest.to_deployment(
        name="every-5-minutes",
        work_pool_name=os.getenv("PREFECT_WORK_POOL", "g2b-pipeline-pool"),
        schedule=Cron(f"*/{interval_minutes} * * * *", timezone=os.getenv("APP_TIMEZONE", "Asia/Seoul")),
        concurrency_limit=ConcurrencyLimitConfig(
...
def deploy_all() -> None:
    ...
    deploy_g2b_success_bid_realtime_ingest()
