...
def normalize_raw_row(row: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "notice_agency_code": clean(raw.get("ntceInsttCd")),
        "notice_agency_name": clean(raw.get("ntceInsttNm")),
        "demand_agency_code": clean(raw.get("dminsttCd")),
        "demand_agency_name": clean(raw.get("dminsttNm")),
