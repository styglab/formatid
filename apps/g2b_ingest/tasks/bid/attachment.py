...
from apps.g2b_ingest.tasks.http import G2bIngestApiClient
from apps.g2b_ingest.tasks.job_keys import build_bid_notice_job_key
    ...
    try:
        ...
        await state_store.upsert_state(
            ...
            error={
                ...
                "message": "task cancelled before attachment download completed",
            },
